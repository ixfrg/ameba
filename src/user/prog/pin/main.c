...
static void parse_user_input(struct arg_pin *dst, int argc, char *argv[])
{
    struct arg_pin initial_value;
    config_pin_parse_default_config(&initial_value);
    
    struct arg_pin_with_parse_state input_arg;
    arg_pin_parse(&input_arg, &initial_value, argc, argv);
