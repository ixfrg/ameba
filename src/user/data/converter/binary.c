...
static long data_converter_binary_convert(void *dst, size_t dst_len, void *data, size_t data_len)
{
...
const struct data_converter data_converter_binary = {
    .convert = data_converter_binary_convert
};