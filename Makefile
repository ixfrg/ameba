...
BPF_OBJS_B_E = $(DIR_BUILD_B_E)/accept.bpf.o $(DIR_BUILD_B_E)/connect.bpf.o $(DIR_BUILD_B_E)/process_namespace.bpf.o $(DIR_BUILD_B_E)/send_recv.bpf.o $(DIR_BUILD_B_E)/bind.bpf.o
BPF_OBJS_B_H = $(DIR_BUILD_B_H)/event_context.bpf.o $(DIR_BUILD_B_H)/record_helper.bpf.o $(DIR_BUILD_B_H)/data_copy.bpf.o
